...
- **Drilling into depth-limited nodes**: The default max_depth is intentionally low. \
Drilling into depth-limited nodes is the primary pattern for exploring documents. \
If a node has depth_limited: true, call read_document with that node's node_id to zoom into the subtree.
