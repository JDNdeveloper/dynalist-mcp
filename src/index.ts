...
notes, colors, headings, and collapsed state. Do NOT attempt to render headings or colors in output \
unless you have rich formatting capabilities (e.g. do not use \`### Foo\` to represent an h3 heading). \
Applies to \
