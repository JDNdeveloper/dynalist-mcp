...
- Before any mutation, preview the intended changes and stop. Wait for the user to explicitly confirm before calling the write tool. Never preview and write in the same response.
