...
| `POST /doc/edit` | `delete_items`, `move_items`, `reorder_items`, `edit_items`, `insert_items` | [/doc/edit](https://apidocs.dynalist.io/#make-change-to-the-content-of-a-document) |
