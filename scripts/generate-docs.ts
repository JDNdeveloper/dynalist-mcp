...
function generateInstructionsMarkdown(): string {
  ...
  lines.push("<!--");
  lines.push("  Generated by scripts/generate-docs.ts from src/instructions.ts. Do not edit by hand.");
  lines.push("  This is the MCP instructions prompt sent to AI agents via the MCP protocol.");
  lines.push("-->");
  lines.push("");
...
const instructionsMd = generateInstructionsMarkdown();
